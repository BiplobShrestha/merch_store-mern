...
export default function Login() {
  ...
  const handleSocial = (provider) => {
    setSocialNote(`${provider} sign-in is coming soon — use email for now.`);
  };
    ...
    <div className="auth-page">
      <div className="auth-split">
        ...
        <div className="auth-card">
          <h1>Welcome back</h1>
          <p className="auth-subtitle">Sign in to check out, track orders, and rate what you've bought.</p>
